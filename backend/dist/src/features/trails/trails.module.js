...
exports.TrailsModule = TrailsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [trails_service_1.TrailsService, trail_model_1.TrailModel, user_model_1.UserModel],
        exports: [trails_service_1.TrailsService, trail_model_1.TrailModel],
    })
], TrailsModule);
